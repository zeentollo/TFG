...
const obtenerProductos = async () => {
  const responseCategoria = await axios.post("https://localhost:3000/subcategoria", { id: categoria.value }, {
    headers: {
  ...
  const responseProductos = await axios.post("https://localhost:3000/productos", { subcategory: categoriaId.value }, {
    headers: {
      'Content-Type': 'application/json',
    },
  });
